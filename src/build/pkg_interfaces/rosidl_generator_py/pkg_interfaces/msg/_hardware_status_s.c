...
bool pkg_interfaces__msg__hardware_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pkg_interfaces.msg._hardware_status.HardwareStatus", full_classname_dest, 50) == 0);
  }
  pkg_interfaces__msg__HardwareStatus * ros_message = _ros_message;
  {  // temperature
...
PyObject * pkg_interfaces__msg__hardware_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pkg_interfaces.msg._hardware_status");
