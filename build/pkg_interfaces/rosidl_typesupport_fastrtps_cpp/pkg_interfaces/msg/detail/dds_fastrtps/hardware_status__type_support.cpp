...
#include "pkg_interfaces/msg/detail/hardware_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pkg_interfaces::msg::HardwareStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pkg_interfaces::msg::HardwareStatus & ros_message)
{
  // Member: temperature
  cdr >> ros_message.temperature;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pkg_interfaces::msg::HardwareStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pkg_interfaces::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pkg_interfaces::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  return &pkg_interfaces::msg::typesupport_fastrtps_cpp::_HardwareStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pkg_interfaces, msg, HardwareStatus)() {
  return &pkg_interfaces::msg::typesupport_fastrtps_cpp::_HardwareStatus__handle;
}
